...
Web アプリでは、**ブラウザとサーバーが別のプログラム**です。お互いの中身を直接さわれません。だから間に「約束」を置いて、その約束を通してやりとりします。

今日つくるのは、この約束です。決めることは、いつも同じ 4 つです。
...
前の章の GET と POST は、2 番目にあたります。**今日はこれをコードで書きます。**
