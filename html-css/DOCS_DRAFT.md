...
- [HTML/CSS を始めよう](#htmlcss-を始めよう)
  - [1. HTML/CSSに触れてみよう](#1-htmlcssに触れてみよう)
    ...
    - [1-2. VisBugを使ってみよう](#1-2-visbugを使ってみよう)
...
<details>
<summary>もう少し詳しく: 各タブの使い分け</summary>
...
Chrome拡張機能 [VisBug](https://chrome.google.com/webstore/detail/visbug/cdockenadnadldjbbgcallicgledbeoc?hl=ja) を入れると、`Alt`+`Shift`+`D` で起動できます。
...
<details>
<summary>もう少し詳しく: マークアップすると何が嬉しい？</summary>
...
<details>
<summary>もう少し詳しく: なぜ `[!DOCTYPE html]` が必要なの？</summary>
...
<details>
<summary>もう少し詳しく: なぜこのルールがあるの？</summary>
...
<details>
<summary>もう少し詳しく: なぜ「見た目だけが目的なら span + CSS」？</summary>
...
<details>
<summary>もう少し詳しく: なぜ `border-box` のほうが直感的？</summary>
...
<details>
<summary>もう少し詳しく: カスタムプロパティを使うと何が嬉しい？</summary>
...
| `font-family` | フォント | ![フォント](imgs/css-font-family-smple.png) |
...
<details>
<summary>もう少し詳しく: HTML構造が複雑になると何が困る？</summary>
